...
export const translations: Record<'zh' | 'en', TranslationText> = {
  zh: {
    ...
    aboutTitle: '张温雅',
    aboutIntro: '我是一名对数据极为敏感、深谙内容生态治理与策略运营的复合型人才。在字节跳动、携程及汇丰等头部企业完成了多项高价值的策略、风控及数据治理项目。同时，我是AI视频先锋探索者，作为初创视频团队成员，探索前沿AI生成视频并在主流平台传播。',
  ...
  en: {
    ...
    aboutIntro: 'I am a data-intelligent strategist specialized in content ecosystem governance, platform operations, and visual AI storytelling. Having worked at major market players like ByteDance, Trip.com, and HSBC Fintech, I bridge quantitative analytics with operational leadership. I am also an AI video pioneer and explorer, joining a cutting-edge startup video production team as a member to explore generative video technologies and broadcast creative content across mainstream channels.',
